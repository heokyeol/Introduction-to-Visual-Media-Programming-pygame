...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pygame.transform.scale(player_img, (48, 100))
...
player_img = pygame.image.load(path.join(img_dir, "trashmaster.png")).convert()
# player_img = pygame.transform.rotate(player_img, 90)
bullet_img = pygame.image.load(path.join(img_dir, "garbage-bag.png")).convert()
bullet_img = pygame.transform.scale(bullet_img, (30,30))
meteor_images = []
# meteor_list = ['meteorBrown_big1.png', 'meteorBrown_med1.png', 'meteorBrown_med1.png',
#                'meteorBrown_med3.png', 'meteorBrown_small1.png', 'meteorBrown_small2.png',
#                'meteorBrown_tiny1.png']
meteor_list = ['BuickerB.png', 'GalardB.png', 'JeepB.png',
               'RamB.png', 'SuperB.png']
for img in meteor_list:
    meteor_images.append(pygame.image.load(path.join(img_dir, img)).convert())
    meteor_images[-1] = pygame.transform.rotate(meteor_images[-1], 180)
    meteor_images[-1] = pygame.transform.scale(meteor_images[-1], (30,60))
explosion_anim = {}
explosion_anim['lg'] = []
explosion_anim['sm'] = []
for i in range(9):
